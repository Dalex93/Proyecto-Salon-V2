            ...
            <div class="card" id="carta">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-4 mx-auto">
                  <a href="citas#uñas" class="reserva">Reservar</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card" id="carta">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-4 mx-auto">
                 <a href="citas#depilacion" class="reserva">Reservar</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card" id="carta">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-4 mx-auto">
                  <a href="citas#cabello" class="reserva">Reservar</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card" id="carta">
              ...
              <div class="card-body">
                ...
                <div class="d-grid gap-2 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-4 mx-auto">
                  <a href="citas#maquillaje" class="reserva">Reservar</a>
                </div>
              </div>
            </div>
          </div>
